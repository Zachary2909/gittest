...
border:none; font-size:18px; left:-370px; top:-300px;   
}
.button4 {background:none;
border:none; font-size:18px; left:-360px; top:-300px;   
}
.button5 {background:none;
border:none; font-size:18px; left:630px; top:-300px;   
}
.button6 {background:none;
border:none; font-size:18px; left:640px; top:-300px;   
}
button:focus, area:focus, select:focus{
        outline: none;}

.button1:hover{box-shadow: 0 1px 1px rgba(0,0,0,0.19), 0 1px 1px rgba(0,0,0,0.23);}
...
<button type="submit" class="apps"><img class="apps-img" src="photos/apps.png" alt=""> </button>
